...
CFLAGS += $(if $(CONFIG_BAND_STEERING),-DCONFIG_BAND_STEERING,)
CFLAGS += $(if $(CONFIG_DOT11R_FT_SUPPORT),-DCONFIG_DOT11R_FT_SUPPORT,)
CFLAGS += $(if $(CONFIG_DOT11K_RRM_SUPPORT),-DCONFIG_DOT11K_RRM_SUPPORT,)
CFLAGS += $(if $(CONFIG_KVRH_SUPPORT),-DCONFIG_KVRH_SUPPORT,)
CFLAGS += $(if $(CONFIG_MBO_SUPPORT),-DCONFIG_MBO_SUPPORT,)
CFLAGS += $(if $(CONFIG_VOW_SUPPORT),-DCONFIG_VOW_SUPPORT,)
CFLAGS += $(if $(CONFIG_WAPP_SUPPORT),-DCONFIG_WAPP_SUPPORT,)
CFLAGS += $(if $(CONFIG_WHNAT_SUPPORT),-DCONFIG_WHNAT_SUPPORT,)
CFLAGS += $(if $(CONFIG_WNM_SUPPORT),-DCONFIG_WNM_SUPPORT,)
